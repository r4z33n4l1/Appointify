                    ...
                    <div className="col-md-6 center-block text-center" style={{ marginTop: '5vh' }}>
                        ...
                        <div className="container">
                            ...
                            <p className="welcome-text">
                                Welcome to Appointify! Please create an account.
                            </p>
                        </div>
                        <div className="container" style={{ maxWidth: 400, textAlign: "left" }}>
                            <form onSubmit={handleSubmit}>
                                ...
                                <button type="submit" className="w-full px-4 py-2 mt-2 text-white bg-blue-600 rounded-md hover:bg-blue-700" style={{ backgroundColor: '#398d86' }}>Sign Up</button>
                            </form>
                        </div>
                    </div>
